...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Projects — Nishat | Web Developer" },
    {
      name: "description",
      content:
        "Explore Nishat's web development projects — from healthcare apps to interactive portfolios.",
    },
  ];
}
...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      github: "#",
      live: "#",
      gradientClass: "bg-gradient-to-r from-fuchsia-400 to-violet-400",
    },
    {
    ...
    },
    {
      ...
      github: "#",
      live: "#",
      gradientClass: "bg-gradient-to-r from-rose-400 to-orange-400",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-lg leading-relaxed">
            Each project is a unique piece of development, crafted with care and attention to detail.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            ...
            >
              {/* Gradient Top Bar */}
              <div className={`h-2 w-full transition-all duration-500 group-hover:h-3 ${project.gradientClass}`} />
        ...
        <div className="text-center mt-20">
          <div className="inline-block rounded-2xl p-8 md:p-10 bg-white/60 backdrop-blur-xl border border-rose-100/50">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold text-white bg-gradient-to-r from-rose-500 to-fuchsia-500 shadow-lg shadow-rose-500/25 transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
              </svg>
